...
#When a charachter length greater than 10 is entered,
#if a charachter length greater than 10 is entered the program will only factor the first 10 digits inputted, and display the last 4
